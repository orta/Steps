...
- (NSString *)encodeForURL
{
    ...
    return (id)CFBridgingRelease(CFURLCreateStringByAddingPercentEscapes(kCFAllocatorDefault, (CFStringRef)self, NULL, legalURLCharactersToBeEscaped, kCFStringEncodingUTF8));
}
...
- (NSString *)encodeForURLReplacingSpacesWithPlus;
{
    ...
    return (id) CFBridgingRelease(CFURLCreateStringByAddingPercentEscapes(kCFAllocatorDefault, (CFStringRef)replaced, NULL, legalURLCharactersToBeEscaped, kCFStringEncodingUTF8));
}
...
- (NSString *)decodeFromURL
{
    ...
    return (id) [decoded stringByReplacingOccurrencesOfString:@"+" withString:@" "];
}
